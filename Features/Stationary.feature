...
@StationaryPage
Scenario: To Verify whether user is able to redirect to greeting cards page
...
@StationaryPage
Scenario: To Verify whether user is able to redirect to Birthday cards page
	Given user is on Home page
	And user managed the cookies 
	When user clicked on Stationary menu button
...
@StationaryPage
Scenario: To Verify whether user is able to redirect to Congratulations cards page
	Given user is on Home page
	And user managed the cookies 
	When user clicked on Stationary menu button
...
@StationaryPage
Scenario: To Verify whether user is able to redirect to Thankyou cards page
	Given user is on Home page
	And user managed the cookies 
	When user clicked on Stationary menu button
...
@StationaryPage
Scenario: To Verify whether user is able to redirect to Wrapping paper page
	Given user is on Home page
	And user managed the cookies 
	When user clicked on Stationary menu button
...
@StationaryPage
Scenario: To Verify whether user is able to redirect to Notebooks page
	Given user is on Home page
	And user managed the cookies 
	When user clicked on Stationary menu button
...
@StationaryPage
Scenario: To Verify whether user is able to redirect to Enamel Pin Badges page
	Given user is on Home page
	And user managed the cookies 
	When user clicked on Stationary menu button
...
@GreetingcardSPage
Scenario: To Verify Display filter sort items 24 per page
	Given user is on Home page
	And user managed the cookies 
...
#@GreetingcardSPage
#Scenario: To Verify Display filter 36 per page
#	Given user is on Home page
#	And user managed the cookies 
#	And user clicked on Stationary menu button
#	And user selected greeting cards catagory to shop
...
#
#@GreetingcardSPage
#Scenario: To Verify Display filter 48 per page
#	Given user is on Home page
#	And user managed the cookies 
#	And user clicked on Stationary menu button
#	And user selected greeting cards catagory to shop
...
@GreetingcardSPage
Scenario: To Verify BestSelling filter sort items 24 per page
	Given user is on Home page
	And user managed the cookies 
	And user clicked on Stationary menu button
	And user selected greeting cards catagory to shop
