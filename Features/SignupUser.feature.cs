...
namespace RedCrossWithBDD.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("Checking functionality of SignUp Dialogue Box of the Application")]
    public partial class CheckingFunctionalityOfSignUpDialogueBoxOfTheApplicationFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Checking functionality of SignUp Dialogue Box of the Application", "A short summary of the feature", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("To Verify whether user is able to signup to the Application with Valid details")]
        [NUnit.Framework.CategoryAttribute("SignupwithValidCredentials")]
        public virtual void ToVerifyWhetherUserIsAbleToSignupToTheApplicationWithValidDetails()
        {
            string[] tagsOfScenario = new string[] {
                    "SignupwithValidCredentials"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("To Verify whether user is able to signup to the Application with Valid details", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
